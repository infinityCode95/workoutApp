...
const clearWorkoutsBtn = document.querySelector('.clear__btn');
...
class Workout {
    ...
    _setDescription() {
        if (this.type === 'running') {
            ...
            this.descrition = `Велотренировка ${new Intl.DateTimeFormat('ru-Ru').format(
                this.date
            )}`
        }
    }
...
class App {
    ...
    constructor() {
        ...
        clearWorkoutsBtn.addEventListener('click', this.reset.bind(this));
    }
